...
public abstract class FetchRestApiClientBase {
  ...
  public void shouldCallApplyObjectsEndpointWithAListOfRefs()
    ...
    objectUnderTest.callSendObjects(
        Project.nameKey("test_repo"), refName, eventCreatedOn, revisions, new URIish(api));
    ...
    String expectedSendObjectsPayload =
        "["
            ...
            + ",\"revisions_data\":["
            + "{\"commit_object\":{\"sha1\":\""
            + revisions.get(0).getCommitObject().getSha1()
            + "\",\"type\":1,\"content\":\"\\u003d\"},"
            + "\"tree_object\":{\"sha1\":\""
            + revisions.get(0).getTreeObject().getSha1()
            + "\",\"type\":2,\"content\":\"MTAwNjQ0IGJsb2IgYmIzODNmNTI0OWM2OGE0Y2M4YzgyYmRkMTIyOGI0YTg4ODNmZjZlOCAgICBmNzVhNjkwMDRhOTNiNGNjYzhjZTIxNWMxMjgwODYzNmMyYjc1Njc1\"},"
            + "\"blobs\":[{\"sha1\":\""
            + revisions.get(0).getBlobs().get(0).getSha1()
            + "\",\"type\":3,\"content\":\"\\u003d\"}]},"
            + "{\"commit_object\":{\"sha1\":\""
            + revisions.get(1).getCommitObject().getSha1()
            + "\",\"type\":1,\"content\":\"Y29tbWl0YmNvbnRlbnQ\\u003d\"},"
            + "\"tree_object\":{\"sha1\":\""
            + revisions.get(1).getTreeObject().getSha1()
            + "\",\"type\":2,\"content\":\"dHJlZWJjb250ZW50\"},"
            + "\"blobs\":[{\"sha1\":\""
