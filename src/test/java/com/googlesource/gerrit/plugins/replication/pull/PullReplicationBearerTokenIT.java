...
public class PullReplicationBearerTokenIT extends PullReplicationSetupIT {
  ...
  public void shouldReplicateNewChangeRefToReplica1() throws Exception {
  ...
  public void shouldReplicateNewChangeRefToReplica2() throws Exception {
    testRepo = cloneProject(createTestProject(project + TEST_REPLICATION_SUFFIX));
