...
public class BearerAuthenticationIT extends ActionITBase {
  ...
  public void shouldReplicateToPrimaryInstance() throws Exception {
    ...
    httpClientFactory.create(source).execute(httpPost, assertHttpResponseCode(201));
  }

  @Test
  @GerritConfig(name = "container.replica", value = "true")
  @GerritConfig(name = "auth.bearerToken", value = "some-bearer-token")
  public void shouldReplicateToReplicaInstance() throws Exception {
    String refName = createRef();
    String sendObjectPayload =
        "{\"label\":\""
            + TEST_REPLICATION_REMOTE
