...
import static com.googlesource.gerrit.plugins.replication.pull.health.PullReplicationTasksHealthCheck.*;
...
public class PullReplicationTasksHealthCheckTest {
  ...
  private static final String SECTION_NAME =
      PLUGIN_NAME + HEALTHCHECK_NAME_SUFFIX;
  ...
  private class TestModule extends AbstractModule {
    ...
    public TestModule(List<String> projects, String periodOfTime) {
      ...
      config.setStringList(HealthCheckConfig.HEALTHCHECK, SECTION_NAME, PROJECTS_FILTER_FIELD, projects);
      config.setString(HealthCheckConfig.HEALTHCHECK, SECTION_NAME, PERIOD_OF_TIME_FIELD, periodOfTime);
      configResource =
          new ConfigResource() {
            @Override
