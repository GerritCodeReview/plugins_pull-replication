...
public class PullReplicationTasksHealthCheckTest {
  ...
  private static final String SECTION_NAME =
      PLUGIN_NAME + PullReplicationTasksHealthCheck.HEALTHCHECK_NAME_SUFFIX;
  ...
  private class TestModule extends AbstractModule {
    ...
    public TestModule(List<String> projects, String periodOfTime) {
      ...
      config.setStringList(HealthCheckConfig.HEALTHCHECK, SECTION_NAME, "projects", projects);
      config.setString(HealthCheckConfig.HEALTHCHECK, SECTION_NAME, "periodOfTime", periodOfTime);
      configResource =
          new ConfigResource() {
            @Override
