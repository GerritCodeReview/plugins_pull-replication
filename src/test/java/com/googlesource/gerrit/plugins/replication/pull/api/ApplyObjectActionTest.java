...
public class ApplyObjectActionTest {
  ...
  public void shouldThrowResourceConflictExceptionWhenMissingParentObject()
    ...
    doThrow(new MissingParentObjectException(Project.nameKey("test_projects"), refName, ObjectId.zeroId())).when(applyObjectCommand).applyObject(any(), anyString(), any(), anyString());
