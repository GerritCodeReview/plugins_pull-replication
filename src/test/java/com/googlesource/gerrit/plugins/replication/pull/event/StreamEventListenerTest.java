...
public class StreamEventListenerTest {
  ...
  public void setup() {
    ...
    objectUnderTest =
        new StreamEventListener(
            INSTANCE_ID, deleteRefCommand, projectInitializationAction, workQueue, fetchJobFactory);
  }
  ...
  @Test
  public void shoulDeleteRefForRefDeleteEvent() throws IOException, RestApiException {
    RefUpdatedEvent event = new RefUpdatedEvent();
    RefUpdateAttribute refUpdate = new RefUpdateAttribute();
