...
public class StreamEventListenerTest {
	...
	public void setup() {
		...
		objectUnderTest = new StreamEventListener(INSTANCE_ID, fetchCommand, projectInitializationAction, workQueue);
	}
	...
	@Test
	public void shouldCreateProjectForProjectCreatedEvent() throws AuthException, PermissionBackendException {
		...
		verify(projectInitializationAction, times(1)).initProject(String.format("%s.git", TEST_PROJECT));
	}
