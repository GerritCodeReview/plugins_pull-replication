...
public class FetchServiceTest {
  ...
  public void setup() throws URISyntaxException {
    ...
    when(source.schedule(projectName, "8f22c45da5ce298291b7329552568aae1bb62c10", uri, state, true))
  ...
  public void shouldFetchRefUpdate() throws InterruptedException, ExecutionException {
    objectUnderTest.fetch(projectName, uri, "8f22c45da5ce298291b7329552568aae1bb62c10");

    verify(source, Mockito.times(1))
        .schedule(projectName, "8f22c45da5ce298291b7329552568aae1bb62c10", uri, state, true);
  }
  ...
  public void shouldSkipFetchWhenUnknownSource()
    ...
    objectUnderTest.fetch(
        projectName, unknownSourceUri, "8f22c45da5ce298291b7329552568aae1bb62c10");

    verify(source, Mockito.never())
        .schedule(
            projectName, "8f22c45da5ce298291b7329552568aae1bb62c10", unknownSourceUri, state, true);
  }
