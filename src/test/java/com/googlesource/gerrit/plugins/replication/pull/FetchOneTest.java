...
public class FetchOneTest {
  ...
  public void shouldDeleteRefWhenAddingDeleteRefSpec() throws IOException {
    ...
    assertThat(objectUnderTest.getFetchRefSpecs()).isEqualTo(List.of(FetchRefSpec.fromRef(TEST_DELETE_REF)));
  }
  ...
  public void shouldAddRefWhenAddingRefSpecToDeleteRefSpec() throws IOException {
    ...
    assertThat(objectUnderTest.getFetchRefSpecs()).isEqualTo(List.of(FetchRefSpec.fromRef(TEST_REF + ":" + TEST_REF)));
  }
