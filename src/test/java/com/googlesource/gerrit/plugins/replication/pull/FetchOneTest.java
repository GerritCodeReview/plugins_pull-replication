...
public class FetchOneTest {
  ...
  public void shouldFilterOutRefsFromFetchReplicationDelta() throws Exception {
    ...
    setupReplicationFilterMock(Set.of(TEST_REF));
  ...
  public void fetchWithoutDelta_shouldPassDeletedRefToFilterWhenMirroringIsEnabled()
    ...
    setupFetchRefsDatabaseMock(Map.of(LOCAL_REF, localRef), Map.of(REMOTE_REF, remoteRef));
    Set<String> expectedRefs = Set.of(LOCAL_REF, REMOTE_REF);
