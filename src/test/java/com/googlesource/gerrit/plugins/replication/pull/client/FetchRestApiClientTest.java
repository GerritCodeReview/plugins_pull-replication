...
public class FetchRestApiClientTest {
  ...
  @Test
  public void shouldCallCreateProjectEndpoint() throws IOException, URISyntaxException {
    ...
    assertThat(httpPut.getURI().getPath()).isEqualTo("/a/plugins/pull-replication/init-project");
    assertThat(httpPut.getURI().getQuery()).isEqualTo("project-name=test_repo.git");
  }
