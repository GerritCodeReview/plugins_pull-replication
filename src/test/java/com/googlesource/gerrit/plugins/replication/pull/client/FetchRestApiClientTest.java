...
public abstract class FetchRestApiClientTest {
  ...
  protected abstract String authenticationURLPrefix();
  ...
  public void shouldCallFetchEndpoint()
    ...
    assertThat(httpPost.getURI().getPath())
        .isEqualTo(
            String.format(
                "%s/projects/test_repo/pull-replication~fetch", authenticationURLPrefix()));
  ...
  public void shouldCallSendObjectEndpoint()
    ...
    assertThat(httpPost.getURI().getPath())
        .isEqualTo(
            String.format(
                "%s/projects/test_repo/pull-replication~apply-object", authenticationURLPrefix()));
    assertAuthentication(httpPost, httpContextCaptor.getValue());
  }
  ...
  public void shouldCallUpdateHEADEndpoint() throws IOException, URISyntaxException {
    ...
    assertThat(httpPut.getURI().getPath())
        .isEqualTo(
            String.format(
                "%s/projects/%s/pull-replication~HEAD", authenticationURLPrefix(), projectName));
