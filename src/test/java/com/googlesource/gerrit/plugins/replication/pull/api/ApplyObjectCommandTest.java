...
public class ApplyObjectCommandTest {
  ...
  public void shouldInsertIntoApplyObjectsCacheWhenApplyObjectIsSuccessful()
    ...
    RevisionData sampleRevisionData = createSampleRevisionData();
    RevisionData sampleRevisionData2 = createSampleRevisionData2();
  ...
  private RevisionData createSampleRevisionData2() {
    RevisionObjectData commitData =
        new RevisionObjectData(sampleCommitObjectId2, Constants.OBJ_COMMIT, new byte[] {});
    RevisionObjectData treeData =
        new RevisionObjectData(sampleTreeObjectId2, Constants.OBJ_TREE, new byte[] {});
    return new RevisionData(Collections.emptyList(), commitData, treeData, Lists.newArrayList());
  }
}
