...
public class ProjectInitializationAction extends HttpServlet {
  ...
  protected void doPut(
    ...
    try {
      ...
      if (checkContentType(contentType, MediaType.JSON_UTF_8)) {
        ...
        initProjectStatus = initProjectWithConfiguration(httpServletRequest, gitRepositoryName, headName);
  ...
  private boolean initProject(String gitRepositoryName, String headName, boolean needsProjectReindexing)
      throws AuthException, PermissionBackendException, IOException {
