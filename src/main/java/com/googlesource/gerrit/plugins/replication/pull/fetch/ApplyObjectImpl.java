...
public class ApplyObjectImpl implements ApplyObject {
  ...
  @Inject
  public ApplyObjectImpl(LocalGitRepositoryManagerProvider gitManagerProvider) {
    this.gitManager = gitManagerProvider.get();
  }

  /* (non-Javadoc)
   * @see com.googlesource.gerrit.plugins.replication.pull.fetch.ApplyObjectFunc#apply(com.google.gerrit.entities.Project.NameKey, org.eclipse.jgit.transport.RefSpec, com.googlesource.gerrit.plugins.replication.pull.api.data.RevisionData[])
   */
  @Override
