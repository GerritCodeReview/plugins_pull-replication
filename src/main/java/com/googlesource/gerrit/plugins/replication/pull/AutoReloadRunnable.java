...
public class AutoReloadRunnable implements Runnable {
  ...
  private PullReplicationFileBasedConfig loadedConfig;
  ...
  public AutoReloadRunnable(
      ...
      PullReplicationFileBasedConfig config,
      SitePaths site,
  ...
  synchronized void reload() {
    String pendingConfigVersion = loadedConfig.getVersion();
    try {
      PullReplicationFileBasedConfig newConfig =
          new PullReplicationFileBasedConfig(site, pluginDataDir);
