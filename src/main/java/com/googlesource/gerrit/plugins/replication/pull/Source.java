  ...
  public Future<?> schedule(
    ...
    synchronized (stateLock) {
      ...
      if (e == null || e.isRetrying()) {
        ...
        if (missingFromFetchOne.isEmpty()) {
          ...
          state.increaseFetchTaskCount(project.get(), missingFromFetchOne);
          repLog.info("added refs [{}] => {} to existing task {}", missingFromFetchOne, project, e);
        }
      }
      return f;
    }
