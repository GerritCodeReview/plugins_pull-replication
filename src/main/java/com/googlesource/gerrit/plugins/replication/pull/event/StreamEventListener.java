...
public class StreamEventListener implements EventListener {
  ...
  private boolean shouldReplicateProject(Event event) {
    ...
    Optional <Source> maybeSource = sources.getAll().stream()
    ...
    if (event instanceof ProjectCreatedEvent) {
      ...
      return source.isCreateMissingRepositories() && source.wouldCreateProject(projectCreatedEvent.getProjectNameKey());
    }
