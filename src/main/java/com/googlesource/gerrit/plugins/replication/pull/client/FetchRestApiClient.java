...
import com.googlesource.gerrit.plugins.replication.pull.api.ApplyObjectAction;
...
public class FetchRestApiClient implements ResponseHandler<HttpResult> {
  ...
  public HttpResult callSendObject(
      Project.NameKey project, String refName, Revs revs, URIish targetUri)
      throws ClientProtocolException, IOException {

    ApplyObjectAction.Input input = new ApplyObjectAction.Input();
    input.label = instanceLabel;
    input.revs = revs;
