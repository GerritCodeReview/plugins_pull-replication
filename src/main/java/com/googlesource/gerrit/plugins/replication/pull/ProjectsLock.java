...
public class ProjectsLock {
  ...
  public LockToken tryLock(Project.NameKey project, String taskId)
      throws UnableToLockProjectException {
  ...
  public static class UnableToLockProjectException extends Exception {
    private String conflictingTaskId;
