...
public class RevisionReader {
   ...
   * <li>DELETE changes
   * <li>git submodule commits, because the git commit hash is not present in this repo. The method
   *     keeps track of the total size of all objects it has processed, and verifies it is below the
