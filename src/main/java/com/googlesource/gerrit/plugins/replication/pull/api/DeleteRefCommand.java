...
import com.googlesource.gerrit.plugins.replication.pull.PullReplicationModule;
...
public class DeleteRefCommand {
  ...
  public DeleteRefCommand(
      ...
      @Named(PullReplicationModule.LOCAL_DISK_REPOSITORY_MANAGER) GitRepositoryManager gitManager) {
