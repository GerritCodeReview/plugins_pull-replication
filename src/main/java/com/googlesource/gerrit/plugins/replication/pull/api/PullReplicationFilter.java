...
public class PullReplicationFilter extends AllRequestFilter {
  ...
  private Response<Map<String, Object>> doInitProject(HttpServletRequest httpRequest)
      throws InitProjectException, RestApiException {
    Optional<String> maybeProjectName = Optional.ofNullable(httpRequest.getParameter(PROJECT_NAME));
