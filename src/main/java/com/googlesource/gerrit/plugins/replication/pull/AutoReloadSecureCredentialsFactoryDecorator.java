...
import com.googlesource.gerrit.plugins.replication.SecureCredentialsFactory;
...
public class AutoReloadSecureCredentialsFactoryDecorator implements CredentialsFactory {
  ...
  private PullReplicationFileBasedConfig config;

  @Inject
  public AutoReloadSecureCredentialsFactoryDecorator(
      SitePaths site, PullReplicationFileBasedConfig config)
