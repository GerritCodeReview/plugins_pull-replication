...
@Singleton
public class PullReplicationFileBasedConfig implements ReplicationConfig {
  ...
  @Inject
  public PullReplicationFileBasedConfig(SitePaths site, @PluginData Path pluginDataDir) {
    this.site = site;
