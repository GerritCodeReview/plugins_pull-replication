...
public class BearerTokenAuthenticationFilter extends AllRequestFilter {
  ...
  public void doFilter(
    ...
    if (bearerToken.isEmpty()) filterChain.doFilter(servletRequest, servletResponse);
    else if (isBasicAuthenticationRequest(requestURI)) {
      filterChain.doFilter(servletRequest, servletResponse);
      ...
      if (authorizationHeader.isEmpty())
        ...
        final boolean isAuthenticated =
            authorizationHeader.map(ah -> extractBearerToken(ah).equals(bearerToken)).orElse(false);
