...
public class SourceConfiguration implements RemoteConfiguration {
  ...
  private final boolean replicateNewRepositories;
  ...
  public SourceConfiguration(RemoteConfig remoteConfig, Config cfg) {
    ...
    replicateNewRepositories = cfg.getBoolean("remote", name, "replicateNewRepositories", true);
  ...
  public boolean replicateNewRepositories() {
    return replicateNewRepositories;
  }
