...
public class FetchRefSpec extends RefSpec {
  ...
  public static FetchRefSpec ofRefSpec(RefSpec refSpec) {
    return new FetchRefSpec(refSpec.toString());
  }

  public static FetchRefSpec ofRef(String refName) {
    return new FetchRefSpec(refName);
  }

  public static List<RefSpec> asListOfRefSpec(List<FetchRefSpec> fetchRefSpecsList) {
    return fetchRefSpecsList.stream().map(FetchRefSpec::toRefSpec).toList();
  }
